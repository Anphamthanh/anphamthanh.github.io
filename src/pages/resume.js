          ...
          <div className="w-100">
            ...
            <p className="lead mb-5">
              <i>
                ...
                engineering team to implement all your business needs and show
                you all the possible ways that technology can help to maximize
          ...
          <div className="w-100">
            ...
            <ul className="fa-ul mb-0">
              ...
              <li>
                ...
                <b>highly available and fault tolerant</b> distritbuted systems
              </li>
              <li>
              ...
              <li>
                <i className="fa-li fa fa-check"></i>
                Experienced in dealing with different types of databases
                including <b>SQL and NoSQL</b>
              </li>
              <li>
                <i className="fa-li fa fa-check"></i>A quick learner and
                builder, I am able to build usable products quickly utilizing
                existing stacks
              </li>
              <li>
                <i className="fa-li fa fa-check"></i>A{" "}
                <b>very hungry learner</b>! I am very fascinated by the new
          ...
          <div className="w-100">
            ...
            <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
              <div className="resume-content">
                ...
                <p>
                  TIKI is the leading e-commerce platform in Vietnam and it is
                  on its way to be a new unicorn of South East Asia. At TIKI, I
                  am
                  <ul>
                    <li>
                    ...
                    <li>
                      ...
                      businesses can build apps to take advantage of the
                      customer base, payment service, and excellent delivery
                      service that Tiki has.
                    </li>
                    <li>
                      Techstack:{" "}
            ...
            <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
              <div className="resume-content">
                ...
                <p>
                  ...
                  being acquired by Tiki, TicketBox has the opportunity to
                  expand its customer base and offer many more attractive
                  services. I was hired to head the engineering at TicketBox and
                  leading the integration of the TicketBox system into Tiki. At
                  TicketBox/Tiki, I
                  <ul>
                    <li>
                      Was in charge of the deliverables of the engineering team
                      of{" "}
                      <a
                    ...
                    <li>
                      Was in charge of integrating TicketBox existing system
                      into Tiki's eco-system
                    </li>
                    <li>
                      Designed infrastructure and implement the ticketing
                      platform and social e-commerce platform for TicketBox
                    </li>
                    <li>
                ...
                <p>
                  ...
                  <ul>
                    ...
                    <li>
                      Techstack:{" "}
                      <b>
                        Go, Angular, NodeJS, Postgres, MariaDB, Redis, AWS...
                      </b>
                    </li>
                  </ul>
                </p>
            ...
            <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
              <div className="resume-content">
                ...
                <p>
                  ...
                  management software system for businesses. At
                  UltimateSoftware, I
                  <ul>
                    <li>
                      Was a member of the elite team of three who built the
                      first cloud platform solution for UltimateSoftware
                    </li>
                    <li>
                      Was in charge of building and maintaining
                      UltimateSoftware's deployment platform on top of OpenStack
                    </li>
                    <li>
                    ...
                    <li>
                      Techstack:{" "}
                      <b>Python, Ruby, Go, Zookeeper, OpenStack,...</b>
                    </li>
                  </ul>
              ...
              <div className="resume-content">
                ...
                <p>
                  ...
                  <ul>
                    ...
                    <li>
                      Built visualization to visualize network deployment
                      topology
                    </li>
                    ...
                    <li>
                      Techstack:{" "}
                      <b>
                        OpenStack, Python, Ruby, AngularJS, JQuery, D3,
                        Dashing...
                      </b>
                    </li>
                  </ul>
            ...
            <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
              <div className="resume-content">
                ...
                <p>
                  OpenSpan focuses on desktop automation, it has a niche market
                  in building automation for non-technical users. At OpenSpan, I
                  <ul>
                    <li>
                      Built back end code for OpenSpan Console to work with
                      Amazon Web Service for Cloud deployment
                    </li>
                    ...
                    <li>
                      Built a cloud-based automated tester program for used by
        ...
        >
          <div className="w-100">
            ...
            <ul className="fa-ul mb-0">
              ...
              <li>
                <i className="fa-li fa fa-check"></i>2<sup>nd</sup> Place,
                Annual Gainesville Mathematics Tournament
              </li>
              <li>
                <i className="fa-li fa fa-check"></i>
              ...
              <li>
                <i className="fa-li fa fa-check"></i>
                Best Newspaper Website 2 Year Division, Georgia Press
                Association
              </li>
            </ul>
          </div>
